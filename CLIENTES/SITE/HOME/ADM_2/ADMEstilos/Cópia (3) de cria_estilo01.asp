...
caminho_teste = Server.MapPath("../../clientes/" & Session("cliente") & "/estilos/" & arquivo & ".css")
...
<form action="cria_estilo02.asp?arquivo=<%= arquivo %>&sobre=<%= sobre %>" method="post" name="form1" target="_self">
 <table width="500" border="1" align="center" cellspacing="0">
  <tr> 
      <td height="20" colspan="2" bordercolor="#000099" bgcolor="#000099"><a href="javascript:history.go(-1)"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Voltar</strong></font></a></td>
  </tr>
  <tr> 
  ...
  <tr valign="top">
   <td width="84" rowspan="3" bordercolor="#999999" bgcolor="#CCCCCC"><font color="#990000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>VISUALIZA&Ccedil;&Atilde;O:</strong></font><br> 
	<IFRAME allowTransparency  id=lateral align=center marginWidth=0 marginHeight=0 src="modelo/default.asp?cliente=<%= Session("cliente") %>&clicavel=false&arquivo=<%= arquivo %>" frameBorder="0" width="200" height="100%"></IFRAME> 
	&nbsp; </td>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
   ...
   <td height="431" nowrap bordercolor="#CCCCCC" bgcolor="#CCCCCC"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
	 ...
	 <tr> 
	  <td bordercolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><br>
	   ...
	   <br>
	   <input name="<%= sobre %>td_font-weight" type="checkbox" id="<%= sobre %>td_font-weight" value="bold"<% if variavel(sobre & "td_font-weight")="bold" then Response.Write(" checked")%>>
  ...
  <tr bordercolor="#CCCCCC"> 
      <td height="20" colspan="2" bgcolor="#CCCCCC"> <a href="../config.asp?cliente=<%= Session("cliente") %>"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Voltar</strong></font></a></td>
  </tr>
 </table>
