	 ...
	 <tr> 
	  <td bordercolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><br>
	   ...
	   <select name="td_font-family" id="td_font-family">
		<option<% if valor_campo(str, "td", "font-family")="" then Response.Write(" selected")%>>Fonte 
		padr&atilde;o</option>
		<option value="Arial"<% if valor_campo(str, "td", "font-family")="Arial" then Response.Write(" selected")%>>Arial</option>
		<option value="Times New Roman"<% if valor_campo(str, "td", "font-family")="Times New Roman" then Response.Write(" selected")%>>Times 
		New Roman</option>
		<option value="Courier New"<% if valor_campo(str, "td", "font-family")="Courier New" then Response.Write(" selected")%>>Courier 
		New</option>
		<option value="Georgia"<% if valor_campo(str, "td", "font-family")="Georgia" then Response.Write(" selected")%>>Georgia</option>
		<option value="Verdana"<% if valor_campo(str, "td", "font-family")="Verdana" then Response.Write(" selected")%>>Verdana</option>
		<option value="Geneva"<% if valor_campo(str, "td", "font-family")="Geneva" then Response.Write(" selected")%>>Geneva</option>
	   </select>
	   <br>
	   Alinhamento horizontal:<br>
	   <select name="td_text-align" id="td_text-align">
		<option value="left"<% if valor_campo(str, "td", "text-align")="left" then Response.Write(" selected")%>>&Agrave; 
		esquerda</option>
		<option value="right"<% if valor_campo(str, "td", "text-align")="right" then Response.Write(" selected")%>>&Agrave; 
		direita</option>
		<option value="center"<% if valor_campo(str, "td", "text-align")="center" then Response.Write(" selected")%>>No 
		centro</option>
		<option value="justify"<% if valor_campo(str, "td", "text-align")="justify" then Response.Write(" selected")%>>Justificado</option>
	   </select>
	   <br>
	   Alinhamento vertical:<br>
	   <select name="td_vertical-align" id="td_vertical-align">
		<option value="top"<% if valor_campo(str, "td", "vertical-align")="top" then Response.Write(" selected")%>>No alto</option>
		<option value="bottom"<% if valor_campo(str, "td", "vertical-align")="bottom" then Response.Write(" selected")%>>Em baixo</option>
		<option value="center"<% if valor_campo(str, "td", "vertical-align")="center" then Response.Write(" selected")%>>No meio</option>
		<option value="baseline"<% if valor_campo(str, "td", "vertical-align")="baseline" then Response.Write(" selected")%>>Linha de base</option>
	   </select>
	   <br>
	   Tamanho: 
	...
	<br>
	 ...
	 <tr> 
	        <td bordercolor="#CCCCCC" bgcolor="#CCCCCC" id="borda_tabela"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
              <input name="td_border" type="text" id="td_border" value="<%= replace(replace(valor_campo(str, "td", "border"), "solid", ""), " ", "") %>" size="3">
	 ...
	 <tr> 
	        <td bordercolor="#CCCCCC" bgcolor="#CCCCCC" id="borda_tabela"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
              <input name="table_border" type="text" id="table_border" value="<%= replace(replace(valor_campo(str, "table", "border"), "solid", ""), " ", "") %>" size="3">
	 ...
	 <tr> 
	        <td bordercolor="#CCCCCC" bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Estilo 
              ...
              <select name="input_font-family" id="select">
                <option<% if valor_campo(str, "input", "font-family")="" then Response.Write(" selected")%>>Fonte 
                padr&atilde;o</option>
                <option value="Arial"<% if valor_campo(str, "input", "font-family")="Arial" then Response.Write(" selected")%>>Arial</option>
                <option value="Times New Roman"<% if valor_campo(str, "input", "font-family")="Times New Roman" then Response.Write(" selected")%>>Times 
                New Roman</option>
                <option value="Courier New"<% if valor_campo(str, "input", "font-family")="Courier New" then Response.Write(" selected")%>>Courier 
                New</option>
                <option value="Georgia"<% if valor_campo(str, "input", "font-family")="Georgia" then Response.Write(" selected")%>>Georgia</option>
                <option value="Verdana"<% if valor_campo(str, "input", "font-family")="Verdana" then Response.Write(" selected")%>>Verdana</option>
                <option value="Geneva"<% if valor_campo(str, "input", "font-family")="Geneva" then Response.Write(" selected")%>>Geneva</option>
              </select>
              <select name="input_text-align" id="select5">
                <option<% if valor_campo(str, "input", "text-align")="" then Response.Write(" selected")%>>Escolha 
                um...</option>
                <option value="left"<% if valor_campo(str, "input", "text-align")="left" then Response.Write(" selected")%>>&Agrave; 
                esquerda</option>
                <option value="right"<% if valor_campo(str, "input", "text-align")="right" then Response.Write(" selected")%>>&Agrave; 
                direita</option>
                <option value="center"<% if valor_campo(str, "input", "text-align")="center" then Response.Write(" selected")%>>No 
                centro</option>
                <option value="justify"<% if valor_campo(str, "input", "text-align")="justify" then Response.Write(" selected")%>>Justificado</option>
              </select>
              <br>
              Tamanho: 
	 ...
	 <tr> 
	  <td bordercolor="#CCCCCC" bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Estilo 
	   ...
	   <select name=".sobre_font-family" id=".sobre_font-family">
		<option<% if valor_campo(str, ".sobre", "font-family")="" then Response.Write(" selected")%>>Não alterar</option>
		<option value="Arial"<% if valor_campo(str, ".sobre", "font-family")="Arial" then Response.Write(" selected")%>>Arial</option>
		<option value="Times New Roman"<% if valor_campo(str, ".sobre", "font-family")="Times New Roman" then Response.Write(" selected")%>>Times 
		New Roman</option>
		<option value="Courier New"<% if valor_campo(str, ".sobre", "font-family")="Courier New" then Response.Write(" selected")%>>Courier 
		New</option>
		<option value="Georgia"<% if valor_campo(str, ".sobre", "font-family")="Georgia" then Response.Write(" selected")%>>Georgia</option>
		<option value="Verdana"<% if valor_campo(str, ".sobre", "font-family")="Verdana" then Response.Write(" selected")%>>Verdana</option>
		<option value="Geneva"<% if valor_campo(str, ".sobre", "font-family")="Geneva" then Response.Write(" selected")%>>Geneva</option>
	   </select>
	   <select name=".sobre_text-align" id=".sobre_text-align">
		<option<% if valor_campo(str, ".sobre", "text-align")="" then Response.Write(" selected")%>>Não Alterar</option>
		<option value="left"<% if valor_campo(str, ".sobre", "text-align")="left" then Response.Write(" selected")%>>&Agrave; 
		esquerda</option>
		<option value="right"<% if valor_campo(str, ".sobre", "text-align")="right" then Response.Write(" selected")%>>&Agrave; 
		direita</option>
		<option value="center"<% if valor_campo(str, ".sobre", "text-align")="center" then Response.Write(" selected")%>>No 
		centro</option>
		<option value="justify"<% if valor_campo(str, ".sobre", "text-align")="justify" then Response.Write(" selected")%>>Justificado</option>
	   </select>
	   <br>
	   Tamanho: 
	   ...
	   <table width="100%" border="1" cellspacing="0" cellpadding="0">
		...
		<tr> 
		 <td bordercolor="#CCCCCC" bgcolor="#CCCCCC" id="borda_tabela"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
		  <input name=".sobre_border" type="text" id=".sobre_border" value="<%= replace(replace(valor_campo(str, ".sobre", "border"), "solid", ""), " ", "") %>" size="3">
