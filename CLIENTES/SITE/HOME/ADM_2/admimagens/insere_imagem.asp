...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr> 
  <td><p><font size="5">./<%= replace(nome_pasta, "\", "/") %></font><br>
        <font color="#990000"><strong>Aten&ccedil;&atilde;o!<br>
        Se houver outro arquivo com o mesmo nome, ser&aacute; substitu&iacute;do! 
        </strong></font><br>
      </p>
   </td>
 </tr>
 <tr> 
  <td><form action="insere_imagem2.asp?cliente=<%= cliente %>&categoria=<%= nome_pasta %>" method="post" enctype="multipart/form-data" name="form1" onSubmit="document.all.Enviar.disabled=true;">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	 ...
	 <tr> 
	  <td><input name="file1" type="file" id="file1" size="50" accept="image/*"></td>
	 </tr>
	 <tr> 
	  <td><input name="Enviar" type="submit" id="Enviar" value="Enviar"> <input type="reset" name="Submit2" value="Cancelar" onClick="javascript:window.open('janela_imagens.asp?categoria=<%= nome_pasta %>', '_self')"></td>
	 </tr>
	</table>
   </form> </td>
 </tr>
