...
<form action="update_grupo.asp?id_grupo=<%= Request.QueryString("id_grupo") %>" method="post" name="form1" target="_self" onSubmit="PegarTexto(this);">
 ...
 <table width="100%" border="1" cellspacing="0" align="center">
  ...
  <tr> 
   <td colspan="2" bgcolor="#CCCCCC"><object id="myEditor" name="myEditor" data="editoru.asp?id_grupo=<%= id_grupo %>" type="text/x-scriptlet" width="100%" height="423">
 ...
 ' If rs_grupo.fields(1) = "HEAD" then
  ...
  <tr bordercolor="#CCCCCC" bgcolor="#CCCCCC"> 
   <td colspan="2" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
	...
	%>
	<textarea name="Head" cols="80" rows="3" style="display: none"><%= head %></textarea>
...
%>
  ...
  <tr> 
   ...
   %>
	...
	<!--<a href="#"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Adicionar/Excluir 
	Menus </strong></font></a>-->
	&nbsp;</td>
  </tr>
  <tr> 
