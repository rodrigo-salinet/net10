 ...
 <table width="500" border="1" align="center" cellspacing="0">
  ...
  <tr valign="top">
   <td width="84" rowspan="3" bordercolor="#999999" bgcolor="#CCCCCC"><font color="#990000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>VISUALIZA&Ccedil;&Atilde;O:</strong></font><br> 
	...
	<IFRAME allowTransparency  id=lateral align=center marginWidth=0 marginHeight=0 src="<%= endereco_virtual %>default.asp?cliente=<%= cliente %>&clicavel=false" frameBorder="0" width="200" height="100%"></IFRAME> 
	&nbsp; </td>
  ...
  <tr valign="top"> 
   <td height="301" nowrap bordercolor="#CCCCCC" bgcolor="#CCCCCC"><table width="100%" border="1" cellspacing="0" cellpadding="0">
	 <tr valign="top"> 
